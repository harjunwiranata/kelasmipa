...
date: '2023-01-22'
tags: ['blooming algae', 'biologi', 'lingkungan']
draft: false
summary: 'Blooming algae yang sering kita lihat di danau atau sungai sekitar ternyata berbahaya bagi lingkungan. Apa saja dampak yg bisa ditimbulkan dan apa penyebab terjadinya?'
---
import Adsense from '@/components/adsense/Source.js'
import InArticle from '@/components/adsense/InArticle.js'
